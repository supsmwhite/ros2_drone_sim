...
- Domain 113 有序多目标真实闭环从首个有效地面 Odom 原地起飞，依次执行 P1 `(4,0,1.5)`、P2 `(8,5,1.5)`、P3 `(4,6.5,3.5)`；观测到目标索引 `0/1/2`、已访问计数 `0/1/2/3`，三段规划起点距同期实际 Odom 仅 `0.002390/0.000429/0.000007 m`，目标接受误差 `0.002382/0.003700/0.003625 m`、接受速度 `0.005765/0.000130/0.000475 m/s`；
