...
def generate_launch_description():
    ...
    environment_sim = os.path.join(
        bringup_share, 'launch', 'environment_sim.launch.py')
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            'use_rviz',
            default_value='true',
            description='Start RViz2 through the included environment simulation.',
        ),
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(environment_sim),
