...
PositionControllerResult PositionController::compute(const PositionControllerInput & input) const
{
  ...
  result.horizontal_proportional_acceleration_world =
    horizontal_result.proportional_acceleration_world;
  result.horizontal_derivative_acceleration_world =
    horizontal_result.derivative_acceleration_world;
  result.horizontal_integral_acceleration_world =
    horizontal_result.integral_acceleration_world;
  result.horizontal_feedforward_acceleration_world =
    horizontal_result.feedforward_acceleration_world;
  result.horizontal_raw_acceleration_world = horizontal_result.raw_acceleration_world;
...
PositionControllerResult PositionController::compute(
  const PositionControllerInput & input, const double dt,
  const bool integrator_enabled)
{
  ...
  horizontal_input.desired_yaw = input.desired_yaw;
  const HorizontalPositionControllerResult horizontal_result =
    horizontal_controller_.compute(horizontal_input, dt, integrator_enabled);
  result.desired_horizontal_acceleration_world = horizontal_result.desired_acceleration_world;
  result.horizontal_proportional_acceleration_world =
    horizontal_result.proportional_acceleration_world;
  result.horizontal_derivative_acceleration_world =
    horizontal_result.derivative_acceleration_world;
  result.horizontal_integral_acceleration_world = horizontal_result.integral_acceleration_world;
  result.horizontal_feedforward_acceleration_world = horizontal_result.feedforward_acceleration_world;
  result.horizontal_raw_acceleration_world = horizontal_result.raw_acceleration_world;
  result.desired_roll = horizontal_result.desired_roll;
  result.desired_pitch = horizontal_result.desired_pitch;
  result.desired_orientation_body_to_world = horizontal_result.desired_orientation_body_to_world;
  result.horizontal_saturated = horizontal_result.saturated;
  ...
  hover_input.desired_vertical_velocity = input.desired_velocity_world.z();
  hover_input.desired_vertical_acceleration = input.desired_acceleration_world.z();
  hover_input.desired_orientation_body_to_world = horizontal_result.desired_orientation_body_to_world;
  hover_input.current_altitude = input.current_position_world.z();
  hover_input.current_vertical_velocity_world = input.current_velocity_world.z();
  hover_input.current_orientation_body_to_world = input.current_orientation_body_to_world;
  hover_input.desired_angular_velocity_body = input.desired_angular_velocity_body;
  hover_input.current_angular_velocity_body = input.current_angular_velocity_body;
  const HoverControllerResult hover_result = hover_controller_.compute(hover_input);
  result.collective_thrust = hover_result.collective_thrust;
...
void PositionController::reset_horizontal_integrator()
{
  horizontal_controller_.reset_integrator();
}
